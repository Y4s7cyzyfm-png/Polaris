...
// Xcode 15.x SDKs predate the A18 CPU-family names used by newer devices.
// Keep the numeric values in sync with current Darwin machine.h so simulator
// analysis and older CI toolchains can still compile the compatibility checks.
...
extern uint32_t off_proc_ro_p_csflags;
